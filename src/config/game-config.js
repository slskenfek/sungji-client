  ...
  global.DungeonConfig = {
    player: {
      ...
      promotion: {
        ...
        chainFeedbackCooldown: 70,
        meleeFeedbackCooldown: 70,
    ...
    equipment: {
      ...
      infernoBurnInterval: 100,
      infernoBurnMaxHpRatio: 0.001,
      tidalAttackRangeMultiplier: 4,
      titanDefensePerStrength: 100,
      tempestMoveSpeedMultiplier: 4,
    },
    supremeBoss: {
      maxHp: 250000000,
      earthDefenseMultiplier: 25,
      projectileMaxHpDamageRatio: 0.12,
      waterDotDuration: 5000,
      waterDotInterval: 500,
      waterDotDamageRatio: 0.025,
      windHealInterval: 1000,
      windHealMaxHpRatio: 0.005,
    },
    room: {
    ...
    monsters: {
      ...
      awakened: {
        ...
        defenseMultiplier: 5,
        damageMultiplier: 8,
        projectileMaxHpDamageRatio: 0.03,
    ...
    progression: {
      ...
      baseXpToNext: 28,
      xpLevelExponent: 2.4,
      gladiatorXpMultiplier: 3,
      secondJobXpMultiplier: 8,
      awakenedXpMultiplier: 20,
      xpRewardBase: 12,
